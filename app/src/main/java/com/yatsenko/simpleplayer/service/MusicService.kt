package com.yatsenko.simpleplayer.service
...
import com.yatsenko.simpleplayer.service.utils.library.AbstractMusicSource
import com.yatsenko.simpleplayer.service.utils.library.JsonSource
import com.yatsenko.simpleplayer.service.utils.library.MusicSource
...
import com.yatsenko.simpleplayer.service.notification.UampNotificationManager
import com.yatsenko.simpleplayer.service.utils.PackageValidator
import com.yatsenko.simpleplayer.service.utils.PersistentStorage
import com.yatsenko.simpleplayer.service.utils.extensions.*
import com.yatsenko.simpleplayer.service.utils.library.*
...
//        packageValidator = PackageValidator(this, R.xml.allowed_media_browser_callers)
    ...
    override fun onLoadChildren(parentMediaId: String, result: Result<MutableList<MediaItem>>) {
        ...
        if (parentMediaId == UAMP_RECENT_ROOT) {
            result.sendResult(storage.loadRecentSong()?.let { song -> mutableListOf(song) })
        } else {
    ...
    override fun onSearch(query: String, extras: Bundle?, result: Result<MutableList<MediaBrowserCompat.MediaItem>>) {
        ...
        val resultsSent = mediaSource.whenReady { successfullyInitialized ->
            if (successfullyInitialized) {
                ...
                result.sendResult(resultsList.toMutableList())
            }
        }
    ...
    private inner class UampQueueNavigator(mediaSession: MediaSessionCompat) : TimelineQueueNavigator(mediaSession) {
